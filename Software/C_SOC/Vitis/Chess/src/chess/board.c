...
bool legal(int c, int r) {
	if (position(c,r) >= 0 && position(c,r) < 64 && c < 8 && r < 8)
		return true;
	else
		return false;
}
...
int getMovesKing(int c, int r, int * board, int *movebuffer, bool white, bool wking, bool bking,
	...
	if(white) {
		...
		if (check == false && wrook1 == false && wking == false && squareSafe(c-1,r,white,board) && squareSafe(c-2,r,white,board)
			&& boardAt(c-1,r,board) == 0 && boardAt(c-2,r,board) == 0 && boardAt(c-3,r,board) == 0) {
...
void redrawCube(int y,int c, int *pos) {
	...
	switch(pos[c+y*8]) {
				...
				case b_rook:
					...
					break;
				case w_rook:
					drawObject(c*60,y*30,60,height,rook_graphics,0x77);
					break;
				...
				case b_pawn:
					...
					break;
				case w_pawn:
					drawObject(c*60,y*30,60,height,pawn_graphics,0x77);
					break;
				...
				case b_king:
					...
					break;
				case w_king:
					drawObject(c*60,y*30,60,height,king_graphics,0x77);
					break;
				...
				case b_knight:
					...
					break;
				case w_knight:
					drawObject(c*60,y*30,60,height,knight_graphics,0x77);
					break;
				...
				case b_queen:
					...
					break;
				case w_queen:
					drawObject(c*60,y*30,60,height,queen_graphics,0x77);
					break;
				...
				case b_bishop:
					...
					break;
				case w_bishop:
					drawObject(c*60,y*30,60,height,bishop_graphics,0x77);
					break;
