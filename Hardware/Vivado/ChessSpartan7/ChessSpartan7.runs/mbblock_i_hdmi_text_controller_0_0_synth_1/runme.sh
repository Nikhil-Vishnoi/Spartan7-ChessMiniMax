...
HD_PWD='C:/Chess/ChessSpartan7/ChessSpartan7.runs/mbblock_i_hdmi_text_controller_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mbblock_i_hdmi_text_controller_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mbblock_i_hdmi_text_controller_0_0.tcl
