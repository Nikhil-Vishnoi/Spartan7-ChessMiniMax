...
HD_PWD='C:/Chess/ChessSpartan7/ChessSpartan7.runs/mbblock_i_xbar_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mbblock_i_xbar_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mbblock_i_xbar_0.tcl
